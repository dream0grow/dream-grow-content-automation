...
> **후속(2026-09-14)**: 아래 🔴 B1·B2는 같은 브랜치에서 수리했다 — 리서치를 Claude 웹 검색(`orchestrator/claude_research.py`)으로 전환하고, 재큐 버그와 미아 카드 구제기를 추가했다. 자세한 내용은 CLAUDE.md 「현재 상태」 참고. 🟠 이하 항목은 미착수.
