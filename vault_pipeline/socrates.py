...
주제가 무엇이든 — 비즈니스, 교육, 심리, 콘텐츠 전략, 재테크, 관계, 방법론, 그 밖의
어떤 영역이든 — 노트가 말하는 바로 그 주제의 논리를 더 깊게 파는 질문을 하십시오.
...
먼저 이 노트가 실제로 다루는 주제 영역과 핵심 주장을 파악하세요 — 영역을 미리 정해진
목록에 끼워 맞추지 말고, 노트가 말하는 그대로 규정하세요(예: '유튜브 채널 수익 구조',
'초등 훈육', '습관 설계', '퍼실리테이션'처럼 구체적으로).
