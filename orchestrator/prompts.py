...
- photo_query: 이 슬라이드 배경으로 어울리는 '실제 사진'을 스톡에서 찾기 위한 영어 검색어
  (예: "korean child school backpack morning", "parent and child doing homework at home",
  "mother comforting crying child"). 사람·상황이 드러나게, 2~5단어 영어로.

출력 (JSON만):
{{
  "slides": [
    {{"kind": "cover", "label": "", "title": "", "body": "", "photo_query": ""}},
    {{"kind": "content", "label": "", "title": "", "body": "", "photo_query": ""}},
    {{"kind": "closing", "label": "", "title": "", "body": "", "photo_query": ""}}
  ]
}}"""
